...
public class ProcessJapeRules {
	...
	public static void main(String[] args) throws GateException, IOException {
		...
		// String ANNIE_HOME =
		// "C:\\Users\\ghamnia\\gate-8.1-build5169-BIN\\plugins\\ANNIE";
		String CORPUS_FOLDER = "jape_rules/corpus";
		String JAPE_RULES_FOLDER = "jape_rules/rules";
		// String TAGGER_FRAMEWORK_FOLDER =
		// "C:\\Users\\ghamnia\\gate-8.1-build5169-BIN\\plugins\\Tagger_Framework";
		String TAGGER_FRAMEWORK_FOLDER = args[1];
		// cr�ation de ANNIE
		...
		taggerParameters.put("taggerBinary", new File(args[2]).toURI().toURL());
